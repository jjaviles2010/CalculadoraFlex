package com.jlapp.calculadoraflex.fcm
...
import com.jlapp.calculadoraflex.utils.NotificationManagerUtils
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(pendingIntent: PendingIntent?, title: String, message: String) {
        ...
        val mBuilder = createNotificationCompatBuilder(applicationContext)
            .setContentTitle(title)
            .setSound(defaultSoundUri).setStyle(NotificationCompat.BigTextStyle())
            .setVisibility(NotificationCompat.VISIBILITY_PUBLIC).setSmallIcon(R.mipmap.ic_launcher)
            .setAutoCancel(true).setContentIntent(pendingIntent).setContentText(message)
